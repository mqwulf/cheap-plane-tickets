...
class FlightSearch:
    ...
    def __init__(self):
        self._api_key = os.environ['PLANE_API_KEY']
        self._api_secret = os.environ['PLANE_API_SECRET']
    ...
    def check_flights(self, originLocationCode, destinationLocationCode, fromTime, toTime):
        headers = {"Authorization": f"Bearer {self._token}"}
        query = {
